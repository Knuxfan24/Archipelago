# TODO: The Brave Stones now always appear as Progression rather than traps, even if the ranking stuff isn't active and thus the player doesn't need them.
...
DEFAULT_ITEM_CLASSIFICATIONS = {
    ...
    "No Stocks": ItemClassification.trap | ItemClassification.progression,
    "Expensive Stocks": ItemClassification.trap | ItemClassification.progression,
    "Double Damage": ItemClassification.trap | ItemClassification.progression,
    "No Revivals": ItemClassification.trap | ItemClassification.progression,
    "No Guarding": ItemClassification.trap | ItemClassification.progression,
    "No Petals": ItemClassification.trap | ItemClassification.progression,
    "Time Limit": ItemClassification.trap | ItemClassification.progression,
    "Items To Bombs": ItemClassification.trap | ItemClassification.progression,
    "Life Oscillation": ItemClassification.trap | ItemClassification.progression,
    "One Hit KO": ItemClassification.trap | ItemClassification.progression,
    ...
    "Madstone": ItemClassification.trap | ItemClassification.progression,
    "Guardian Charm": ItemClassification.useful,
    "Explosive Finale": ItemClassification.trap | ItemClassification.progression,
    "Idol of Greed": ItemClassification.trap | ItemClassification.progression,
    "Bomb Magnet": ItemClassification.trap | ItemClassification.progression,
    "Ninja Garb": ItemClassification.useful | ItemClassification.progression,
    "Ice Crown": ItemClassification.useful,
    "Invisibility Cloak": ItemClassification.trap | ItemClassification.progression,
    "Gravity Boots": ItemClassification.trap | ItemClassification.progression,
