# TODO: Split this into multiple files? Its getting a bit crowded at this point.
# TODO: Sit down and look at transitioning this to the new RuleBuilder setup.
...
def set_all_location_rules(world: FP2World) -> None:
    ...
    # Checks for the player having a negative Brave Stone. One Hit KO is checked seperately so this can be reused for Rainbow S-Ranks.
    def requiresBraveStone(state: CollectionState) -> bool:
        return state.has_any(["No Stocks", "Expensive Stocks", "Double Damage", "No Revivals", "No Guarding", "No Petals", "Time Limit", "Items To Bombs", "Life Oscillation", "Madstone", "Explosive Finale", "Idol of Greed", "Bomb Magnet", "Invisibility Cloak", "Gravity Boots"], world.player)
    
    # Add the Brave Stone and One Hit KO requirements if Rainbow S-Ranks are required.
    if world.options.rainbow_s_rank:
        set_rule(world.get_location("Dragon Valley - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Dragon Valley - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Shenlin Park - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Shenlin Park - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Tiger Falls - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Tiger Falls - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Robot Graveyard - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Robot Graveyard - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Shade Armory - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Shade Armory - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Snowfields - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Snowfields - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Avian Museum - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Avian Museum - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Airship Sigwada - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Airship Sigwada - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Phoenix Highway - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Phoenix Highway - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Zao Land - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Zao Land - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Globe Opera 1 - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Globe Opera 1 - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Globe Opera 2 - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Globe Opera 2 - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Auditorium - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Auditorium - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Palace Courtyard - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Palace Courtyard - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Tidal Gate - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Tidal Gate - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Sky Bridge - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Sky Bridge - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Lightning Tower - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Lightning Tower - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Zulon Jungle - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Zulon Jungle - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Nalao Lake - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Nalao Lake - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Ancestral Forge - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Ancestral Forge - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Magma Starscape - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Magma Starscape - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Diamond Point - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Diamond Point - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Gravity Bubble - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Gravity Bubble - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Bakunawa Chase - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Bakunawa Chase - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Bakunawa Rush - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Bakunawa Rush - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Refinery Room - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Refinery Room - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Clockwork Arboretum - Rainbow S-Rank"), requiresBraveStone)
        ...
        set_rule(world.get_location("Battlebot Battle Royale - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Battlebot Battle Royale - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Hero Battle Royale - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Hero Battle Royale - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Kalaw's Challenge - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Kalaw's Challenge - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Army of One - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Army of One - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Ring-Out Challenge - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Ring-Out Challenge - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Flip Fire Gauntlet - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Flip Fire Gauntlet - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Vanishing Maze - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Vanishing Maze - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Mondo Condo - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Mondo Condo - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Birds of Prey - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Birds of Prey - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Battlebot Revenge - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Battlebot Revenge - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Mach Speed Melee - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Mach Speed Melee - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Galactic Rumble - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Galactic Rumble - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Stop and Go - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Stop and Go - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Mecha Madness - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Mecha Madness - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Rolling Thunder - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Rolling Thunder - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Blast from the Past - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Blast from the Past - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
        set_rule(world.get_location("Bubble Battle - Rainbow S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Bubble Battle - Rainbow S-Rank"), lambda state: state.has("One Hit KO", world.player), "and")
    
        # Add the Brave Stone requirements if S-Ranks are set to logically require them, including the UT glitched flag.
    if world.options.s_rank and world.options.s_rank_brave_stones:
        set_rule(world.get_location("Dragon Valley - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Dragon Valley - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Dragon Valley - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Shenlin Park - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Shenlin Park - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Shenlin Park - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Tiger Falls - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Tiger Falls - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Tiger Falls - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Robot Graveyard - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Robot Graveyard - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Robot Graveyard - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Shade Armory - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Shade Armory - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Shade Armory - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Snowfields - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Snowfields - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Snowfields - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Avian Museum - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Avian Museum - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Avian Museum - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Airship Sigwada - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Airship Sigwada - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Airship Sigwada - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Phoenix Highway - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Phoenix Highway - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Phoenix Highway - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Zao Land - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Zao Land - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Zao Land - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Globe Opera 1 - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Globe Opera 1 - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Globe Opera 1 - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Globe Opera 2 - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Globe Opera 2 - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Globe Opera 2 - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Auditorium - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Auditorium - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Auditorium - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Palace Courtyard - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Palace Courtyard - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Palace Courtyard - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Tidal Gate - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Tidal Gate - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Tidal Gate - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Sky Bridge - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Sky Bridge - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Sky Bridge - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Lightning Tower - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Lightning Tower - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Lightning Tower - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Zulon Jungle - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Zulon Jungle - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Zulon Jungle - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Nalao Lake - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Nalao Lake - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Nalao Lake - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Ancestral Forge - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Ancestral Forge - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Ancestral Forge - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Magma Starscape - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Magma Starscape - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Magma Starscape - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Diamond Point - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Diamond Point - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Diamond Point - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Gravity Bubble - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Gravity Bubble - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Gravity Bubble - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Bakunawa Chase - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Bakunawa Chase - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Bakunawa Chase - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Bakunawa Rush - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Bakunawa Rush - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Bakunawa Rush - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Refinery Room - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Refinery Room - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Refinery Room - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Clockwork Arboretum - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Clockwork Arboretum - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Clockwork Arboretum - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        ...
        add_rule(world.get_location("Beginner's Gauntlet - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Battlebot Battle Royale - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Battlebot Battle Royale - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Battlebot Battle Royale - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Hero Battle Royale - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Hero Battle Royale - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Hero Battle Royale - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Kalaw's Challenge - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Kalaw's Challenge - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Kalaw's Challenge - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Army of One - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Army of One - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Army of One - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Ring-Out Challenge - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Ring-Out Challenge - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Ring-Out Challenge - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Flip Fire Gauntlet - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Flip Fire Gauntlet - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Flip Fire Gauntlet - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Vanishing Maze - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Vanishing Maze - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Vanishing Maze - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Mondo Condo - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Mondo Condo - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Mondo Condo - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Birds of Prey - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Birds of Prey - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Birds of Prey - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Battlebot Revenge - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Battlebot Revenge - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Battlebot Revenge - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Mach Speed Melee - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Mach Speed Melee - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Mach Speed Melee - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Galactic Rumble - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Galactic Rumble - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Galactic Rumble - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Stop and Go - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Stop and Go - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Stop and Go - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Mecha Madness - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Mecha Madness - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Mecha Madness - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Rolling Thunder - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Rolling Thunder - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Rolling Thunder - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Blast from the Past - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Blast from the Past - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Blast from the Past - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        set_rule(world.get_location("Bubble Battle - S-Rank"), requiresBraveStone)
        add_rule(world.get_location("Bubble Battle - S-Rank"), lambda state: state.has("One Hit KO", world.player), "or")
        add_rule(world.get_location("Bubble Battle - S-Rank"), lambda state: state.has(world.glitches_item_name, world.player), "or")
        
    # Add the Battlesphere Key requirements to the Rank Locations as well.
    if world.options.rainbow_s_rank:
        add_rule(world.get_location("Beginner's Gauntlet - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 1))
        add_rule(world.get_location("Battlebot Battle Royale - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 2))
        add_rule(world.get_location("Hero Battle Royale - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 3))
        add_rule(world.get_location("Kalaw's Challenge - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 4))
        add_rule(world.get_location("Army of One - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 5))
        add_rule(world.get_location("Ring-Out Challenge - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 6))
        add_rule(world.get_location("Flip Fire Gauntlet - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 7))
        add_rule(world.get_location("Vanishing Maze - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 8))
        add_rule(world.get_location("Mondo Condo - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 9))
        add_rule(world.get_location("Birds of Prey - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 10))
        add_rule(world.get_location("Battlebot Revenge - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 11))
        add_rule(world.get_location("Mach Speed Melee - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 12))
        add_rule(world.get_location("Galactic Rumble - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 13))
        add_rule(world.get_location("Stop and Go - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 14))
        add_rule(world.get_location("Mecha Madness - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 15))
        add_rule(world.get_location("Rolling Thunder - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 16))
        add_rule(world.get_location("Blast from the Past - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 17))
        add_rule(world.get_location("Bubble Battle - Rainbow S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 18))
    if world.options.s_rank:
        add_rule(world.get_location("Beginner's Gauntlet - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 1))
        add_rule(world.get_location("Battlebot Battle Royale - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 2))
        add_rule(world.get_location("Hero Battle Royale - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 3))
        add_rule(world.get_location("Kalaw's Challenge - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 4))
        add_rule(world.get_location("Army of One - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 5))
        add_rule(world.get_location("Ring-Out Challenge - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 6))
        add_rule(world.get_location("Flip Fire Gauntlet - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 7))
        add_rule(world.get_location("Vanishing Maze - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 8))
        add_rule(world.get_location("Mondo Condo - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 9))
        add_rule(world.get_location("Birds of Prey - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 10))
        add_rule(world.get_location("Battlebot Revenge - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 11))
        add_rule(world.get_location("Mach Speed Melee - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 12))
        add_rule(world.get_location("Galactic Rumble - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 13))
        add_rule(world.get_location("Stop and Go - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 14))
        add_rule(world.get_location("Mecha Madness - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 15))
        add_rule(world.get_location("Rolling Thunder - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 16))
        add_rule(world.get_location("Blast from the Past - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 17))
        add_rule(world.get_location("Bubble Battle - S-Rank"), lambda state: state.has("Battlesphere Key", world.player, 18))
    if world.options.a_rank:
        add_rule(world.get_location("Beginner's Gauntlet - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 1))
        add_rule(world.get_location("Battlebot Battle Royale - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 2))
        add_rule(world.get_location("Hero Battle Royale - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 3))
        add_rule(world.get_location("Kalaw's Challenge - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 4))
        add_rule(world.get_location("Army of One - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 5))
        add_rule(world.get_location("Ring-Out Challenge - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 6))
        add_rule(world.get_location("Flip Fire Gauntlet - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 7))
        add_rule(world.get_location("Vanishing Maze - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 8))
        add_rule(world.get_location("Mondo Condo - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 9))
        add_rule(world.get_location("Birds of Prey - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 10))
        add_rule(world.get_location("Battlebot Revenge - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 11))
        add_rule(world.get_location("Mach Speed Melee - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 12))
        add_rule(world.get_location("Galactic Rumble - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 13))
        add_rule(world.get_location("Stop and Go - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 14))
        add_rule(world.get_location("Mecha Madness - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 15))
        add_rule(world.get_location("Rolling Thunder - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 16))
        add_rule(world.get_location("Blast from the Past - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 17))
        add_rule(world.get_location("Bubble Battle - A-Rank"), lambda state: state.has("Battlesphere Key", world.player, 18))
